	...
	<div class="Container" style="padding: 30px;">
		<div class="row">
				...
				<div id="insertForm">
					<form id="formItem" name="formItem" style="padding: 10px;">
						<div class="form-row">
							...
							<div class="form-group col-md-3">
								<label for="inputState">Hospital ID:</label> <select
									id="hospitalId" name="hospitalId" class="form-control">
									<option value="" selected>Choose...</option>
						...
						<div class="form-group">
							<label for="inputAddress">Patient Name:</label> <input
						...
						<div class="form-row">
							<div class="form-group col-md-4">
								<label for="inputCity">Hospital Charges:</label> <input
									type="text" class="form-control" id="hospitalCharges"
									name="hospitalCharges" placeholder="0.00" value="1000.00"
									readonly>
							</div>
							<div class="form-group col-md-4">
								<label for="inputCity">Doctor Charges:</label> <input
									type="text" class="form-control" id="doctorCharges"
									name="doctorCharges" value="1000.00" placeholder="0.00"
									readonly>
							</div>
							<div class="form-group col-md-4">
								<label for="inputCity">Total Amount:</label> <input type="text"
									class="form-control" id="totalAmount" name="totalAmount"
									value="2000.00" placeholder="0.00" readonly>
							</div>
						</div>
						<div class="form-row">
				...
				<div id="formItemClass">
					<form id="formItem2" name="formItem2" style="padding: 10px;">
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								<label for="inputCity">Telephone:</label> <input type="text"
									class="form-control" id="telephone2" name="telephone2"
									placeholder="07XXXXXXXX">
							</div>
						</div>
						<input type="button" id="btnSave2" name="btnSave2" value="Save"
							class="btn btn-success"> <input type="hidden"
							id="hidPaymentIDSave2" name="hidPaymentIDSave2" value="">
					</form>
				</div>
			...
			<div class="col-md-6">
				...
				<div id="divCanceledPaymentsGrid" class="Container"
					style="padding: 10px;">
					<%
